...
@Component({
  selector: "gv-kairos-item-editor",
  standalone: true,
  imports: [
    FormsModule,
    InputTextModule,
  ...
  templateUrl: "./kairos-item-editor.component.html",
  styleUrl: "./kairos-item-editor.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class KairosItemEditorComponent {
