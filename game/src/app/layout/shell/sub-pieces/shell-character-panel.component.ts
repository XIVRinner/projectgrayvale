...
import { PurseAccordionComponent } from "../../../shared/components/purse-accordion/purse-accordion.component";
...
@Component({
  ...
  standalone: true,
  imports: [GapWarningComponent, ImagePreviewComponent, PurseAccordionComponent, ProgressBarComponent, StatAccordionComponent],
